...
<head>
	...
	<title>Carta - Top Rolls - Sushi y Wok</title>
	<!-- Stylesheets -->
...
<body>
				...
				<div class="row mt30">
					<div class="col-md-12">
						<ul class="nav nav-tabs" role="tablist">
							...
							<li class="active"><a href="#tab-california" role="tab" data-toggle="tab">Top Rolls</a>
							</li>
                                            ...
                                            <div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">43. Chicken Roll</a>
															</h6>
															<p class="for-list">(queso crema, cebollín y pollo) envuelto en palta</p>
													  </div>
 ...
 <div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">45. Mix Roll</a>
															</h6>
															<p class="for-list">(kanikama, palta y queso crema) envuelto en salmón y palta</p>
														</div>
										...
										<div class="col-md-6">
											<div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">47. Pulpo Roll</a> </h6>
														  <p class="for-list">(kanikama, palta y queso crema) envuelto en pulpo</p>
													  </div>
                                      ...
                                      <div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">67. Futomaki</a>															</h6>
														  <p class="for-list">(salmón, palta, queso crema)</p>
														</div>
                                            ...
                                            <div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">287. Ceviche Roll</a>															</h6>
