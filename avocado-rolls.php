...
<body>
 ...
 <div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">27. Avocado Vegetariano</a>
															</h6>
 ...
 <div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">28. Avocado Premiun</a>
															</h6>
 ...
 <div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">29. Avocado Camarón</a>
															</h6>
											...
											<div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">33. Avocado Meat Palta</a>
															</h6>

															<p class="for-list">(carne de vacuno, ají verde y palta)</p>
														</div>
										...
										<div class="col-md-6">
											<div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">34. Avocado Chill Meat</a> </h6>
														  <p class="for-list">(carne de vacuno, ají verde y queso crema)</p>
													  </div>
											...
											<div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">35. Avocado Meat Cheese </a>															</h6>
                                            ...
                                            <div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">36. Avocado Sake Tempura</a>															</h6>
														  <p class="for-list">(salmón, tempura, queso crema y cebollín)</p>
														</div>
                                            ...
                                            <div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">37. Avocado Ebi Tempura</a>															</h6>
														  <p class="for-list">(camarón tempura, queso crema y cebollín)</p>
													  </div>
                                            ...
                                            <div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">38. Avocado Ostión Tempura</a>															</h6>
														  <p class="for-list">(ostión tempura, cebollín y queso crema)</p>
														</div>
                                            ...
                                            <div class="item-list">
												<div class="all-details">
													<div class="visible-option">
														<div class="details">
															<h6><a href="#">40. Avocado Fish Roll</a>															</h6>
														  <p class="for-list">(tilapia, queso crema y cebollín)</p>
													  </div>
