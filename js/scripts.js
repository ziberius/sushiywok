(function ($) {
    ...
    $(document).ready(function () {
        ...
        function showMessage(message) {
           ...
           </span></button><strong>Notificación</strong><p>" + message + "</p></div>").appendTo("body").fadeIn().delay(2000).fadeOut();
        }

        if(getParameterByName("menuitem") === "californias"){
            $("#liCalifornias").addClass("active");
        }else
